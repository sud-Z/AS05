...
if ( !empty($_POST)) { // if not first time through
	...
	if(!preg_match("/^[0-9]{3}-[0-9]{3}-[0-9]{4}$/", $mobile)) {
		...
		// update data
			...
			Database::disconnect();
			header("Location: disc_player_list.php");
		}
	} else {
		$pdo = Database::connect();
		$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
...
<body>
    <div class="container">
    			...
    			<div class="span10 offset1">
    				<div class="row">
		    			<h3>Update a Disc Golf Player</h3>
		    		</div>
    		
	    			<form class="form-horizontal" action="disc_player_update.php?id=<?php echo $id?>" method="post">
					  ...
					  <div class="form-actions">
						  ...
						  <a class="btn" href="disc_player_list.php">Back</a>
						</div>
					</form>
				</div>
